...
CREATE OR REPLACE FUNCTION sys.tinyint2smalldatetime(sys.TINYINT)
RETURNS sys.SMALLDATETIME
AS $$
  SELECT $1::SMALLINT;
$$
...
CREATE CAST (sys.TINYINT AS sys.SMALLDATETIME)
WITH FUNCTION sys.tinyint2smalldatetime (sys.TINYINT) AS IMPLICIT;
