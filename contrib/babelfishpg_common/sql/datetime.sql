...
CREATE OR REPLACE FUNCTION sys.tinyint2datetime(sys.TINYINT)
RETURNS sys.DATETIME
AS $$
  SELECT $1::SMALLINT;
$$
...
CREATE CAST (sys.TINYINT AS sys.DATETIME)
WITH FUNCTION sys.tinyint2datetime (sys.TINYINT) AS IMPLICIT;
